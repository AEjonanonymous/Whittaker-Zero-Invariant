...
* ⚙️ `tb/tb_WhittakerReceiver.sv` - Automated Icarus Verilog testbench module.
* 📝 `Formal Verification of Whittaker-Type Zero-Invariant Fields and Receiver Symmetry Breaking in Lean 4 and SystemVerilog.pdf` - Complete pre-print manuscript.
